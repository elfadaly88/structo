        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    IssuedToUserId = table.Column<Guid>(type: "uuid", nullable: false),
                    Amount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PettyCashes_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PettyCashes_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PettyCashes_Users_IssuedToUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SitePhotos_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SitePhotos_Users_UploadedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PettyCashes_IssuedToUserId",
                table: "PettyCashes",
                column: "IssuedToUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PettyCashes_ProjectId",
                table: "PettyCashes",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_PettyCashes_TenantId",
                table: "PettyCashes",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SitePhotos_UploadedByUserId",
                table: "SitePhotos",
