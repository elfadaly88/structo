...
namespace Structo.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260903174518_AddDailySiteLogsAndPunchList")]
    partial class AddDailySiteLogsAndPunchList
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Structo.Core.Entities.FinancialTransaction", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "Type", "TransactionDate")
            ...
            modelBuilder.Entity("Structo.Core.Entities.PaymentAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("ExtraProjectsCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Structo.Core.Entities.PettyCash", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "Status", "SourcePoolId")
            ...
            modelBuilder.Entity("Structo.Core.Entities.SiteDailyLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("MaterialsDelivered")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
                    ...
                    b.Property<string>("WorkforceSummary")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
            ...
            modelBuilder.Entity("Structo.Core.Entities.SitePunchItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("DefectPhotoUrl")
                        .IsRequired()
                        .HasMaxLength(1500)
                    ...
                    b.HasIndex("SiteTaskId");

                    b.HasIndex("Status");

                    b.HasIndex("TenantId");

                    b.ToTable("SitePunchItems");
                });

            modelBuilder.Entity("Structo.Core.Entities.SiteTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Structo.Core.Entities.SiteTaskSettlementItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SiteTaskSettlementItems");
                });

            modelBuilder.Entity("Structo.Core.Entities.SubscriptionTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("ExtraProjectsAdded")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ResultingMaxProjects")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Structo.Core.Entities.Tenant", b =>
                {
                    ...
                    b.Property<bool>("IsCleanupExempt")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Structo.Core.Entities.PaymentAttempt", b =>
                {
                    b.HasOne("Structo.Core.Entities.SubscriptionTransaction", "LinkedTransaction")
                        .WithMany()
            ...
            modelBuilder.Entity("Structo.Core.Entities.SitePunchItem", b =>
                {
                    ...
                    b.HasOne("Structo.Core.Entities.SiteTask", "SiteTask")
                        .WithMany()
                        .HasForeignKey("SiteTaskId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Project");

                    b.Navigation("SiteTask");
                });

            modelBuilder.Entity("Structo.Core.Entities.SiteTask", b =>
                {
                    b.HasOne("Structo.Core.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Structo.Core.Entities.SiteTaskSettlementItem", b =>
                {
                    b.HasOne("Structo.Core.Entities.SettlementLine", "SettlementItem")
                        .WithMany()
                    ...
                    b.HasOne("Structo.Core.Entities.SiteTask", "SiteTask")
                        .WithMany("LinkedSettlementItems")
                        .HasForeignKey("SiteTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Structo.Core.Entities.SiteTask", b =>
                {
                    b.Navigation("LinkedSettlementItems");
                });
