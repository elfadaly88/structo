...
var FinancialService = class _FinancialService {
  ...
  getProjectFinancialSummary(projectId) {
    return this.http.get(`${this.baseUrl}/${projectId}/financialtransactions/summary`);
  }
  getProjectTransactions(projectId, pageNumber = 1, pageSize = 1e3) {
    const params = new HttpParams().set("pageNumber", pageNumber.toString()).set("pageSize", pageSize.toString());
...
//# sourceMappingURL=chunk-2UGJS3SK.js.map
