...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-RXKJSTXX.js").then((m) => m.LandingPageComponent)
  },
  {
    path: "login",
    loadComponent: () => import("./chunk-3NS4DVLI.js").then((m) => m.LoginComponent)
  },
  {
    path: "register",
    loadComponent: () => import("./chunk-IIUALREZ.js").then((m) => m.TenantRegisterComponent)
  },
  {
    path: "dashboard",
    loadComponent: () => import("./chunk-SUOGPNNA.js").then((m) => m.DashboardLayoutComponent),
    ...
    children: [
      ...
      {
        path: "overview",
        loadComponent: () => import("./chunk-FZ6WHITI.js").then((m) => m.OverviewComponent),
        data: { roles: ["SuperAdmin"] }
      },
      {
        path: "projects",
        loadComponent: () => import("./chunk-PUQ3LH37.js").then((m) => m.ProjectsComponent),
        data: { roles: ["TenantOwner", "Accountant", "Manager", "SiteEngineer", "DesignEngineer"] }
      },
      {
        path: "projects/:id",
        loadComponent: () => import("./chunk-THQHRYXP.js").then((m) => m.ProjectDetailsComponent),
        data: { roles: ["TenantOwner", "Accountant", "Manager", "SiteEngineer", "DesignEngineer"] }
      },
      {
        path: "financials",
        loadComponent: () => import("./chunk-DEPJLJ2O.js").then((m) => m.FinancialsComponent),
        data: { roles: ["TenantOwner", "Accountant", "Manager", "SiteEngineer", "DesignEngineer"] }
      },
      {
        path: "users",
      ...
      {
        path: "profile",
        loadComponent: () => import("./chunk-PJRA6MFK.js").then((m) => m.TenantProfileComponent),
        data: { roles: ["TenantOwner"] }
      },
      {
        path: "tenants",
        loadComponent: () => import("./chunk-IGJ2KDK6.js").then((m) => m.TenantsComponent),
        data: { roles: ["SuperAdmin"] }
      },
      {
        path: "pending-users",
        loadComponent: () => import("./chunk-67W6Y3G2.js").then((m) => m.PendingUsersComponent),
        data: { roles: ["SuperAdmin"] }
      }
    ]
  },
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-4HR5UMPM.js").then((m) => m.ProjectReviewComponent)
  },
  {
    path: "**",
    redirectTo: ""
...
var jwtInterceptor = (req, next) => {
  ...
  let authReq = req;
  const isApiRequest = req.url.startsWith(environment.apiUrl) || req.url.startsWith("https://structo-production.up.railway.app/api") || req.url.startsWith("/api") || req.url.includes("/api/");
